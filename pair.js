...
//================================ ALIVE ==================================
     ...
     const content = `𝙄𝙢 𝙌𝙪𝙚𝙚𝙣 𝙎𝙝𝙖𝙡𝙖 𝙈𝙞𝙣𝙞 𝙒𝙝𝙖𝙩𝙨𝙖𝙥𝙥 𝘽𝙤𝙩 𝘾𝙧𝙚𝙖𝙩𝙚 𝘽𝙮 𝙈𝙍 𝙇𝙊𝙆𝙐 🕊️💐\n\n` +
                    `🧬 \`𝙑𝙚𝙧𝙨𝙞𝙤𝙣:\` ${config.BOT_VERSION}\n` +
                    `📡 \`𝙃𝙤𝙨𝙩:\` Heroku\n` +
                    `⏰ \`𝙍𝙪𝙣𝙩𝙞𝙢𝙚:\` ${hours}h ${minutes}m ${seconds}s\n` +
                    `👨‍💻 \`𝙊𝙬𝙣𝙚𝙧:\` ${config.OWNER_NAME}\n\n` +
                    `𝙄 𝙖𝙢 𝙌𝙪𝙚𝙚𝙣 𝙎𝙝𝙖𝙡𝙖 𝙈𝙞𝙣𝙞 𝙬𝙝𝙖𝙩𝙨𝙖𝙥𝙥 𝙗𝙤𝙩 🔰. 𝙃𝙤𝙬 𝙘𝙖𝙣 𝙄 𝙝𝙚𝙡𝙥 𝙮𝙤𝙪? 𝙄𝙛 𝙮𝙤𝙪 𝙣𝙚𝙚𝙙 𝙩𝙤 𝙠𝙣𝙤𝙬 𝙨𝙤𝙢𝙚𝙩𝙝𝙞𝙣𝙜 𝙖𝙗𝙤𝙪𝙩 𝙩𝙝𝙚 𝙗𝙤𝙩, 𝙐𝙨𝙚 .𝙤𝙬𝙣𝙚𝙧 𝙖𝙣𝙙 𝙙𝙞𝙧𝙚𝙘𝙩 𝙩𝙝𝙚 𝙦𝙪𝙚𝙨𝙩𝙞𝙤𝙣 𝙩𝙤 𝙢𝙚. 𝙂𝙤𝙤𝙙 𝙙𝙖𝙮 💕.\n` +
                    `▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n` +
                    `𝑩𝑶𝑻 𝑾𝑬𝑩: https://shala-md.vercel.app/mini.html\n` +
                    `▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n` +
                    `𝑪𝑯𝑨𝑵𝑬𝑳: https://whatsapp.com/channel/0029Vb1WkmNJP2121yQf143q\n` +
                    `▬▬▬▬▬▬▬▬▬▬▬▬▬▬`;
